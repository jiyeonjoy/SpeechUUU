...
import choi02647.com.speechu.Streaming.Rtc_peer.Kurento.Models.Response.TypeResponse;
import choi02647.com.speechu.Streaming.Util.RxScheduler;
import choi02647.com.speechu.Streaming.Rtc_peer.Kurento.Models.Response.ServerResponse;
/**
 *
 */
...
public class BroadCasterPresenter extends MvpBasePresenter<BroadCasterView>
    ...
    private static final String TAG = BroadCasterPresenter.class.getSimpleName()+"aaaaaaaaaaaaa";

    private static final String STREAM_HOST =  "https://15.164.102.182:8443/one2many";
